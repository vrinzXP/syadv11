...
// Base © °syad°Hw Mods : Copyan Dari Base Dika
...
{
"optionName": "SALAM BROTHER BY © °syad°͢"
}
],
...
break
//=================================================//
case 'syadtroli2': case 'syadtrol': case 'jutrol': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
break
case 'syadtroli3': case 'syadtrol2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
haikal.sendMessage(m.chat, {document: yy, mimetype: 'application/octet-stream', fileName:`© °syad°APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
}
}
break
//=================================================//
case 'syaddaca': case 'syaddaca':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
for (let i = 0; i < jumlah; i++) {
 ...
 haikal.sendMessage(m.chat, {document: ilih, mimetype: '', fileName:`© °syad°APIs ~ 404 ${buttonkal}.HW` }, {quoted:doc})
 }
 }
 break
//=================================================//
case 'syaddocu': case 'syaddraknes':  {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'duc': case 'syadslebew': case 'cumadocu': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'syadvirtext1': case 'syadsu': case 'crashar1': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
...
break
case 'syadvirtext2': case 'syadtol': case 'crashar2': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'syadvirtext3': case 'syadmemek': case 'crashar3': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'syadvirtext4': case 'syadcontol': case 'crashar4': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'syadvirtext5': case 'syadtextv': case 'crashar5': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'syadvirtext6': case 'syadgas': case 'crashar6':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'syadvirtext7': case 'syadvirtext': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'syadvirtext8': case 'syadvirtext1': case 'crashar7':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'syadvirtext9': case 'syadvirtext2': case 'crashar8':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
case 'syadvirtext10': case 'syadvirtext3': case 'crashar9': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Jumlahnya?`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'syadbug1': case 'syadcrash': case 'crashar10':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'syadbug2': case 'syadcrash1': case 'crashar11': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
{ quickReplyButton: { displayText: `HW MODS WA`, id: `KILL`}},
 ...
 break
//=================================================//
case 'syadbug3': case 'syadcrash2': case 'crashar12': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'syadabug4': case 'syadcrash3': case 'crashar13':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'syadbug5': case 'syadcrash4': case 'crashar14': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
case 'syadbug6': case 'syadcrash5': case 'crashar15':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'syadbug7': case 'syadcrash6': case 'crashar16':{
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'syadbug8': case 'syadcrash7': case 'crashar17': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
"status": "INQUIRY",
"surface": "CATALOG",
"message": `© © °syad°͢${ngazap(prefix)}`,
"jpegThumbnail":fs.readFileSync('./baseikal/image/pict.jpg'),
"orderTitle": `© © °syad°͢${ngazap(prefix)}`,
...
break
//=================================================//
case 'syadstik': case 'syadkangbug': case 'buttonkematian': case 'crashar19': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'syadbugie': case 'syadkangbug1': case 'crashar20': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'syadbutton': case 'syadkangbuttton': case 'testbutton': case 'inibutton': 
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
break
//=================================================//
case 'syadbokep': case 'syadngentod': {
if (!isCreator) return
if (isBan) throw sticBanLu(from)
if (args.length == 0) return m.reply(`Penggunaan ${prefix+command} jumlah\nContoh ${prefix+command} 5`)
jumlah = `${encodeURI(q)}`
...
haikal.sendMessage(m.chat, anuala, `© °syad°͢${ngazap(prefix)}`, m)
}
}
break
case 'bugcrot' :
...
if (isBan) throw sticBanLu(from)
haikal.public = true
reply('Sukses To Public By Bot Syad No Spam Dek')
}
break
//=================================================//
case 'self': {
...
if (isBan) throw sticBanLu(from)
haikal.public = false
reply('Sukses To Self By Bot Syad Ga Bisa Spam Ya Dek')
}
break
//=================================================//
case 'nowa': {
...
┗━━⊱
 ▰▱▰▱▰▱▰▱▰▱▰▱▰▱
© °syad°͢`, contextInfo:{"externalAdReply": {"title": `SC °syad°͢`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
}
}}, { quoted:m})
...
┣❏afk { kasih reactions }
┣❏syadghoib [ on / off ]
┣❏syadjagoan [ reply target ]
┣❏syadsange [ Harus Menjadi Admin ]
...
┣❏crashmex 628xxx|5|5
┣❏syadskuy 628xxx
┣❏syadsantet 628xxx@s.whatsapp.net|10|10s
┣❏catalogpc 628xxx@s.whatsapp.net|10|10s
┗━━⊱[°☆タ𝐒𝐘𝐀𝐃𝐃 𝐄𝐗𝐄𝐂𝐔𝐓𝐄𝐃⏧☆⏧°]
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
Ketik > m.chat ( di group dulu )
┏━━⊱[ GROUP ]
┣❏gassyad 112674448xxx
┣❏syadsantetgc  1237891xxxx@g.us|10|10s
...
┣❏syad𝐯irtext4 [ jumlah ]
┣❏syad𝐯irtext5 [ jumlah ]
┣❏syada𝐯irtext6 [ jumlah ]
┣❏syad𝐯irtext7 [ jumlah ]
┣❏syad𝐯irtext8 [ jumlah ]
┣❏syad𝐯irtext9 [ jumlah ]
┣❏syad𝐯irtext10 [ jumlah ]
┗━━⊱[°☆タ𝐒𝐘𝐀𝐃𝐃 𝐄𝐗𝐄𝐂𝐔𝐓𝐄𝐃⏧☆⏧°]
▬▭▬▭▬▭▬▭▬▬▭▬▭▬
...
┗━━⊱[°☆タ𝐒𝐘𝐀𝐃𝐃 𝐄𝐗𝐄𝐂𝐔𝐓𝐄𝐃⏧☆⏧°]`,
contextInfo:{"externalAdReply": {"title": `SC °☆タ𝐒𝐘𝐀𝐃𝐃 𝐄𝐗𝐄𝐂𝐔𝐓𝐄𝐃⏧☆⏧°͢`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
}
}}, { quoted:m})
...
┣❏ngeselin
┗━━⊱[ © °syad°]`,
contextInfo:{"externalAdReply": {"title": `SC © °syad°͢`,"body": `Selamat ${salam} kak ${pushname}`,
previewType: "PHOTO",
showAdAttribution: true,
sourceUrl: `https://youtube.com/c/HwModsWa857`,
thumbnailUrl: 'https://telegra.ph/file/a5e229afeb4dad4f35204.jpg', 
